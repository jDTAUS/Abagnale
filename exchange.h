...
/* $JDTAUS: exchange.h 9614 2026-07-02 05:37:55Z schulte $ */
...
enum order_status {
  ORDER_STATUS_PENDING = 1 << 0,
  ORDER_STATUS_OPEN = 1 << 1,
  ORDER_STATUS_FILLED = 1 << 2,
  ORDER_STATUS_CANCELLED = 1 << 3,
  ORDER_STATUS_EXPIRED = 1 << 4,
  ORDER_STATUS_FAILED = 1 << 5,
  ORDER_STATUS_UNKNOWN = 1 << 6,
  ORDER_STATUS_QUEUED = 1 << 7,
  ORDER_STATUS_CANCEL_QUEUED = 1 << 8,
};
