-- $JDTAUS: database-postgresql.sql 9628 2026-07-07 23:40:36Z schulte $
...
\restrict 8B9EQybmbQV84q4ufMzaIXHpr9uJ0ZO0s6eHZHk5R8LRkbXu7D0CsJJLqB2aDZW
...
CREATE DATABASE "ABAGNALE" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C';


ALTER DATABASE "ABAGNALE" OWNER TO abagnale;

\unrestrict 8B9EQybmbQV84q4ufMzaIXHpr9uJ0ZO0s6eHZHk5R8LRkbXu7D0CsJJLqB2aDZW
\connect "ABAGNALE"
\restrict 8B9EQybmbQV84q4ufMzaIXHpr9uJ0ZO0s6eHZHk5R8LRkbXu7D0CsJJLqB2aDZW
...
BEGIN
	SELECT
		...
		max(extract(EPOCH FROM "SELL_ORDER_DONE_AT")
			- extract(EPOCH FROM "SELL_ORDER_CREATED_AT")),
		avg(extract(EPOCH FROM "SELL_ORDER_DONE_AT")
			- extract(EPOCH FROM "SELL_ORDER_CREATED_AT"))
	INTO
...
CREATE TABLE public."STATISTICS" (
    ...
    CONSTRAINT "STATISTICS_BUY_ORDER_CANCEL_FACTOR_check" CHECK (("BUY_ORDER_CANCEL_FACTOR" >= (1)::numeric)),
    ...
    CONSTRAINT "STATISTICS_MIN_BUY_ORDER_DURATION_NANOS_check" CHECK ((("MIN_BUY_ORDER_DURATION_NANOS" IS NULL) OR ("MIN_BUY_ORDER_DURATION_NANOS" >= (0)::numeric))),
    CONSTRAINT "STATISTICS_MIN_SELL_ORDER_DURATION_NANOS_check" CHECK ((("MIN_SELL_ORDER_DURATION_NANOS" IS NULL) OR ("MIN_SELL_ORDER_DURATION_NANOS" >= (0)::numeric))),
    CONSTRAINT "STATISTICS_SELL_ORDER_CANCEL_FACTOR_check" CHECK (("SELL_ORDER_CANCEL_FACTOR" >= (1)::numeric))
);
...
ALTER TABLE ONLY public."IDENTIFIERS"
    ADD CONSTRAINT "IDENTIFIERS_pkey" PRIMARY KEY ("EXCHANGE_ID", "SYMBOL", "ID");
...
ALTER TABLE ONLY public."STATISTICS"
    ADD CONSTRAINT "STATISTICS_pkey" PRIMARY KEY ("EXCHANGE_ID", "MARKET_ID");
...
ALTER TABLE ONLY public."TREND_PLOTS"
    ADD CONSTRAINT "TREND_PLOTS_pkey" PRIMARY KEY ("EXCHANGE_ID", "MARKET_ID");
...
ALTER TABLE ONLY public."TREND_STATES"
    ADD CONSTRAINT "TREND_STATES_pkey" PRIMARY KEY ("EXCHANGE_ID", "MARKET_ID");


--
-- Name: IDENTIFIERS_EXCHANGE_ID_SYMBOL_idx; Type: INDEX; Schema: public; Owner: abagnale
--

CREATE INDEX "IDENTIFIERS_EXCHANGE_ID_SYMBOL_idx" ON public."IDENTIFIERS" USING btree ("EXCHANGE_ID", "SYMBOL");
...
--
-- Name: TRADES_EXCHANGE_ID_MARKET_ID_STATUS_idx; Type: INDEX; Schema: public; Owner: abagnale
--

CREATE INDEX "TRADES_EXCHANGE_ID_MARKET_ID_STATUS_idx" ON public."TRADES" USING btree ("EXCHANGE_ID", "MARKET_ID", "STATUS");
...
--
-- Name: TREND_CANDLES_EXCHANGE_ID_MARKET_ID_idx; Type: INDEX; Schema: public; Owner: abagnale
--

CREATE INDEX "TREND_CANDLES_EXCHANGE_ID_MARKET_ID_idx" ON public."TREND_CANDLES" USING btree ("EXCHANGE_ID", "MARKET_ID");


--
-- Name: TREND_MARKERS_EXCHANGE_ID_MARKET_ID_PLOT_ID_idx; Type: INDEX; Schema: public; Owner: abagnale
--

CREATE INDEX "TREND_MARKERS_EXCHANGE_ID_MARKET_ID_PLOT_ID_idx" ON public."TREND_MARKERS" USING btree ("EXCHANGE_ID", "MARKET_ID", "PLOT_ID");


--
-- Name: TREND_PLOTS_EXCHANGE_ID_MARKET_ID_PLOT_ID_idx; Type: INDEX; Schema: public; Owner: abagnale
--

CREATE INDEX "TREND_PLOTS_EXCHANGE_ID_MARKET_ID_PLOT_ID_idx" ON public."TREND_PLOTS" USING btree ("EXCHANGE_ID", "MARKET_ID", "PLOT_ID");
...
--
-- Name: TREND_CANDLES TREND_CANDLES_EXCHANGE_ID_MARKET_ID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: abagnale
--

ALTER TABLE ONLY public."TREND_CANDLES"
    ADD CONSTRAINT "TREND_CANDLES_EXCHANGE_ID_MARKET_ID_fkey" FOREIGN KEY ("EXCHANGE_ID", "MARKET_ID") REFERENCES public."TREND_PLOTS"("EXCHANGE_ID", "MARKET_ID") ON DELETE CASCADE;


--
-- Name: TREND_MARKERS TREND_MARKERS_EXCHANGE_ID_MARKET_ID_fkey; Type: FK CONSTRAINT; Schema: public; Owner: abagnale
--

ALTER TABLE ONLY public."TREND_MARKERS"
    ADD CONSTRAINT "TREND_MARKERS_EXCHANGE_ID_MARKET_ID_fkey" FOREIGN KEY ("EXCHANGE_ID", "MARKET_ID") REFERENCES public."TREND_PLOTS"("EXCHANGE_ID", "MARKET_ID") ON DELETE CASCADE;
